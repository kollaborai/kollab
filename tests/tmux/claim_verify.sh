#!/bin/bash
# Helper script for agents to claim/complete verify tests

CHECKLIST="$(dirname "$0")/VERIFY_CONVERSION_CHECKLIST.md"
...
show_usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  $0 claim verify_input_box_hiding.sh agent1"
    echo "  $0 done verify_input_box_hiding.sh agent1"
    echo "  $0 list"
}
