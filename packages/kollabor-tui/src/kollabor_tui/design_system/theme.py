...
THEMES = {
    ...
    "dark": Theme(
        "dark",
        primary=[(55, 55, 55), (40, 40, 40), (55, 55, 55)],
        secondary=[(40, 40, 40), (50, 50, 50), (40, 40, 40)],
        response_bg=[(10, 10, 10), (4, 4, 4), (10, 10, 10)],
        input_bg=[(8, 8, 8), (4, 4, 4), (8, 8, 8)],
        dark=[(8, 8, 8), (6, 6, 6), (8, 8, 8)],
        user_tag=(70, 70, 70),
        ai_tag=(60, 60, 60),
        tool_tag=(45, 45, 50),
        thinking_tag=(45, 42, 38),
        success=[(60, 100, 60), (60, 100, 60), (60, 100, 60)],
        error=[(120, 50, 50), (120, 50, 50), (120, 50, 50)],
        warning=[(120, 100, 40), (120, 100, 40), (120, 100, 40)],
        text=(255, 255, 255),
        text_dim=(90, 90, 90),
    ),
}
